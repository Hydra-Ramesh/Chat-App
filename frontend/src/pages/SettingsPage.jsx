...
const SettingsPage = () => {
  ...
  return (
    <div className='h-screen constainer mx-auto px-4 pt-20 max-w-5xl'>
      <div className='space-y-6'>
        <div flex flex-col gap-1>
          <h2 className='text-lg font-semibold'>Theme</h2>
          <p className='text-sm text-base-content/70'>Choose a theme for your chat Interview</p>
        </div>
        <div className='grid grid-cols-4 sm:grid-cols-66 md:grid-cols-8 gap-2'>
          {
            THEME.map((t)=>(
              <button
              key={t}
